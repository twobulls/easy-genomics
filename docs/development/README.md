...
| [graphify.md](./graphify.md)                               | Graphify guide: concepts, project setup, Cursor + Claude Code, examples    | ✅ Available                |
| [graphify-evaluation-log.md](./graphify-evaluation-log.md) | Pilot A/B test results (tokens, speed, quality) — contribute via PR        | 🧪 Pilot — add your rows    |
| [CLAUDE.md](../../CLAUDE.md)                               | AI contributor guide: domains, auth, patterns (pair with Graphify)         | ✅ Available                |
