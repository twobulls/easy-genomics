...
| v1.5 → v1.5.1   | 1    | `org-email-assets` bucket made private, served via a new CloudFront distribution (OAC); no data migration, no configuration change — drop any local BPA workaround patch | —                                                                                                   |
