<script setup lang="ts">
  ...
  async function initializePipelineData() {
    ...
    usePipelineRunStore().updateWipPipelineRun(pipelineRunTempId, { pipelineDescription: schema.value.description });
    if (res.params) {
      usePipelineRunStore().updateWipPipelineRun(pipelineRunTempId, { params: JSON.parse(res.params) });
    }
  }
  ...
  function resetRunPipeline() {
    usePipelineRunStore().updateWipPipelineRun(pipelineRunTempId, {
      userPipelineRunName: '',
      pipelineDescription: '',
      params: {},
    });
