...
- **[Development](./docs/development/)** — local back-end development, contributing conventions,
  **[architecture](./docs/development/architecture.md)**, and **[Graphify](./docs/development/graphify.md)** (knowledge
