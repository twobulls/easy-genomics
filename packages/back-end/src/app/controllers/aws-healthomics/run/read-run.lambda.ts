...
/**
 * This GET /aws-healthomics/run/read-run/:{RunId}?laboratoryId={LaboratoryId}
 * API queries the same region's AWS HealthOmics service to retrieve a specific
 * Run's details, and it expects:
