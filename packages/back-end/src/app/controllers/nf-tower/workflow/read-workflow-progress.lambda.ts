...
export const handler: Handler = async (
  ...
  try {
    ...
    const response: WorkflowProgressResponse = await httpRequest<WorkflowProgressResponse>(
      `${process.env.SEQERA_API_BASE_URL}/workflow/${id}/progress?${apiQueryParameters}`,
      REST_API_METHOD.GET,
