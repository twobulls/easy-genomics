...
export const handler: Handler = async (
  ...
  try {
    ...
    const response: DescribePipelineSchemaResponse = await httpRequest<DescribePipelineSchemaResponse>(
      `${process.env.SEQERA_API_BASE_URL}/pipelines/${id}/schema?${apiQueryParameters}`,
      REST_API_METHOD.GET,
